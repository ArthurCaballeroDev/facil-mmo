            ...
            if($page != 'login' && $page != 'new' && $page != 'password'){
                ?>
                    ...
                    <ul class="side-nav" id="mobile-menu">
                        ...
                        if(admin()==1){
                            ?>
                                <li class="<?php echo ($page=="write")?"active" : ""; ?>"><a href="index.php?page=write">Publier une annonce</a></li>
                                <li class="<?php echo ($page=="list")?"active" : ""; ?>"><a href="index.php?page=list">Listing des annonces</a></li>
